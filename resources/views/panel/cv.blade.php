                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="card-text">Yapay zeka teknolojilerindeki son gelişmeler ve uygulamalar.</p>
                            <a href="" class="btn btn-primary">Devamı için tıklayınız</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="card-text">Dağıtık defter teknolojisinin geleceği ve potansiyel kullanım alanları.</p>
                            <a href="" class="btn btn-primary">Devamı için tıklayınız</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="card h-100">
                        <div class="card-body">
                            ...
                            <p class="card-text">API nedir, nasıl çalışır, yazılım projelerinde nasıl kullanılır?</p>
                            <a href="" class="btn btn-primary">Devamı için tıklayınız</a>
                        </div>
                    </div>
                </div>
